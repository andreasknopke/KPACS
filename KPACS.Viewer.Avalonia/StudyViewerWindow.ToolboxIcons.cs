...
public partial class StudyViewerWindow
{
    ...
    private void InitializeToolboxIcons()
    {
        ...
        ConfigureIconButton(Toolbox3DCursorButton, Create3DCursorIcon(), "3D cursor: hold SHIFT while clicking in a viewport. Click here to clear the current 3D cursor.");
